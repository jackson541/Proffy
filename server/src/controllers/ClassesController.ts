...
import convertHourToString from '../utils/convertHourToMinutes'
...
export default class ClassesController {
    async index(request: Request, response: Response) {
        ...
        const timeInMinutes = convertHourToString(filter.time as string)
        ...
        try {
            ...
            const classSchedule = schedules.map((scheduleItem: ScheduleItem) => {
                return {
                    ...
                    from: convertHourToString(scheduleItem.from),
                    to: convertHourToString(scheduleItem.to)
                }
            })
